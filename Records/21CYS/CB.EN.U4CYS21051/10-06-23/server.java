    ...
    void start() {
        while (true) {
            try {
                ...
                System.err.println("An error occurred while accepting a 
client connection: " + e.getMessage());
                e.printStackTrace();
            }
        }
    }
...
DataInputStream(clientSocket.getInputStream());
                ...
                System.err.println("An error occurred while handling a 
client connection: " + e.getMessage());
                e.printStackTrace();
            }
        }).start();
...
FileTransferServer(SERVER_PORT);
            ...
            System.err.println("An error occurred while starting the 
server: " + e.getMessage());
            e.printStackTrace();
        }
    }
